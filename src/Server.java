...
public class Server  implements ActionListener {
    ...
    Server() {
        ...
        f.setLocation(200, 50);   //frame location on screen
    ...
    public static void main(String[] arg)
    {
        ...
        try{
            ServerSocket skt=new ServerSocket(6001); // creating server
            while(true){
                Socket skt1=skt.accept();
                din=new DataInputStream(skt1.getInputStream()); // input messages
                dout=new DataOutputStream(skt1.getOutputStream());// output messages
                while(true)
                {
